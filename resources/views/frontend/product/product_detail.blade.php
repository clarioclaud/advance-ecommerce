									...
									<div class="col-sm-2">
										<div class="cart-quantity">
											<div class="quant-input">
								                ...
								                <input type="text" value="1" min="1" value="1" id="pqty">
						...
						<div class="col-sm-9">
							...
							<div class="tab-content">
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
									@php
										$reviews = App\Models\Reviews::where('product_id',$product->id)->latest()->limit(5)->get();
									@endphp
										...
										<div class="product-add-review">
											...
											<div class="review-form">
												@guest
												<p><b>To make Product Review...You must Login First...<a href="{{ route('login') }}">Login Here</a></b></p>
												@else
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="{{ url('product/detail/'.$product->id.'/'.$product->product_slug_en) }}"><img  src="{{ asset($product->product_thumbnail) }} " alt=""></a>
			</div><!-- /.image -->			
						@php
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="{{ url('product/detail/'.$product->id.'/'.$product->product_slug_en) }}"> @if(session()->get('language')=='hindi')   {{ $product->product_name_hin }} @else   {{ $product->product_name_en }} @endif</a></h3>
			<div class="rating rateit-small"></div>
