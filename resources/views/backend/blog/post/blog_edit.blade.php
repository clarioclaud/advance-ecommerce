		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form action="{{ route('update.blogpost') }}" method="post" enctype="multipart/form-data">
					  @csrf	
                        <input type="hidden" name="id" value="{{ $id->id }}">
                        <input type="hidden" name="old_image" value="{{ $id->blog_image }}">
                        <div class="row"> <!--// start  row 2-->
                            ...
                            <div class="col-md-6">
								...
								<div class="controls">
									<input type="text" name="blog_title_en" class="form-control" value="{{ $id->blog_title_en }}" required="" > 
                                </div>
                                @error('blog_title_en')
                            ...
                            <div class="form-group">
								...
								<div class="controls">
									<input type="text" name="blog_title_hin" class="form-control" value="{{ $id->blog_title_hin }}" required="" > 
                                </div>
						...
						<div class="row"> <!--// start  row 6-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select name="category_id" class="form-control" aria-invalid="false" required="">
                                            ...
                                            <option value="{{ $cat->id }}" {{ $cat->id == $id->category_id ? 'selected':'' }} >{{ $cat->blog_category_name_en }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('category_id')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">   
                                        <input type="file" name="blog_image" class="form-control" onchange="ImageUrl(this);" > 
                                        <img src="{{ asset($id->blog_image) }}" alt="blog" height="100px" width="100px">
                                    </div>
                                    @error('blog_image')
                                            <span class="text-danger">{{ $message }}</span>
                                    @enderror 
						...
						<div class="text-xs-right">
							<input type="submit" class="btn btn-rounded btn-info" name="submit" value="Update Blog Post">
						</div>
					</form>
