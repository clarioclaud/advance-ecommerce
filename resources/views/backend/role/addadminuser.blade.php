					  ...
					  <div class="row">
						<div class="col-12">
                            ...
                            <div class="row">
								...
								<div class="controls">
									<input type="text" name="phone" class="form-control" data-validation-required-message="This field is required"> <div class="help-block"></div></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <img id="showimage" src="{{ url('uploads/no_image.jpg')  }}" width="100px" height="100px">
                                </div>
                            ...
                            <div class="row"> <!--// start  row 9-->
						        <div class="col-md-4">
									...
									<div class="controls">
										<fieldset>
											<input type="checkbox" id="checkbox_2" name="brands" value="1" >
											<label for="checkbox_2">Brands</label>
										</fieldset>
										<fieldset>
											<input type="checkbox" id="checkbox_3" name="categories"  value="1">
											<label for="checkbox_3">Categories</label>
										</fieldset>
                                        <fieldset>
											<input type="checkbox" id="checkbox_4" name="products"  value="1">
							...
							<div class="form-group">
									...
									<div class="controls">
                                        ...
                                        <fieldset>
											<input type="checkbox" id="checkbox_10" name="returnorders" value="1">
						...
						<div class="text-xs-right">
							<input type="submit" name="submit" class="btn btn-rounded btn-primary mb-5" value="Add Admin User">
						</div>
					</form>
